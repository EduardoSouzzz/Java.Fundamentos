...
public class MinhaClass_2 {
    public static void main(String[] args) {
        ...
        float nota4Bimestre = LerNotas.nextFloat();


        float MEDIA = (nota1Bimestre + nota2Bimestre + nota4Bimestre + nota4Bimestre) / 4;
        ...
        if (MEDIA < 5){
            ...
            System.out.println("Informação INVALIDA, Por favor, Informe suas notas novamente");
        System.out.println("A sua NOTA Final foi de: " + MEDIA);
